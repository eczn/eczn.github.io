    ...
    return {
        ...
        execute: (function () {
            ...
            const meta = exports('meta', metaBeauty({
                ...
                author: 'eczn',
                category: '艺术',
                intro: '对于没有系统学过画画且基本没有啥天分的我来说能抓好形就不错了 ... 但这个时代有 AI，在两年前我就玩过 webui，不过当时也不是很懂这块，但这段时间简单我又尝试了一下现在 AI 相关的绘画管线，感觉它非常适合一些 “风格” 化的渲染和上色，能打开很多创意思维，感觉如果构造+调教合适的话，确实能作为生产力使用了，总之 webui 启动！ 本文做简单记录',
                tags: ['摸鱼', 'AI'],
